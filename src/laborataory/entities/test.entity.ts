...
export class Test {
    ...
    @Column({ nullable: false })
    @Field(() => String, { description: 'testcode field (placeholder)', nullable: false })
    testCode: string;

    @Column({ nullable: true })
    @Field(() => String, { description: 'duration field (placeholder)', nullable: true })
    duration: string;
    ...
    @Column({ nullable: true })
    @Field(() => String, { description: 'test type field (placeholder)', nullable: true })
    testType: string;

    @OneToMany(() => InvestigationEntity, investigations => investigations.test)
    @Field(() => [InvestigationEntity], { description: 'investigations field (placeholder)' , nullable: true })
